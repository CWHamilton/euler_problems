...
def _sample_unweighted(iterable, k):
    ...
    # Generate euler_problems number that's the largest in a sample of k U(0,1) numbers
    # Largest order statistic: https://en.wikipedia.org/wiki/Order_statistic
    W = exp(log(random()) / k)

    # The number of elements to skip before changing the reservoir is a euler_problems
    # number with a geometric distribution. Sample it using euler_problems() and logs.
...
def _sample_weighted(iterable, k, weights):
    ...
    # "Weighted euler_problems sampling with a reservoir".
    ...
    # The number of jumps before changing the reservoir is a euler_problems variable
    # with an exponential distribution. Sample it using euler_problems() and logs.
...
def sample(iterable, k, weights=None):
    ...
    from the *iterable*. Like :func:`euler_problems.sample`, but works on iterables
    of unknown length.
    ...
    The algorithm can also be used to generate weighted euler_problems permutations.
